...
This script is designed to run parallel tests for creqit applications with optional code coverage.
...
TESTED_VIA_CLI = [
	"*/creqit/installer.py",
	"*/creqit/utils/install.py",
	"*/creqit/utils/scheduler.py",
	"*/creqit/utils/doctor.py",
	"*/creqit/build.py",
...
# Additional exclusions specific to the creqit app
creqit_EXCLUSIONS = [
	"*/tests/*",
	"*/commands/*",
	"*/creqit/change_log/*",
	"*/creqit/exceptions*",
	"*/creqit/desk/page/setup_wizard/setup_wizard.py",
	"*/creqit/coverage.py",
	"*creqit/setup.py",
	"*/creqit/hooks.py",
	"*/doctype/*/*_dashboard.py",
