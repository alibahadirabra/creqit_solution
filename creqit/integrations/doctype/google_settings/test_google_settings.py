...
class TestGoogleSettings(IntegrationTestCase):
	def setUp(self):
		settings = creqit.get_single("Google Settings")
	...
	def test_picker_disabled(self):
		...
		creqit.db.set_single_value("Google Settings", "enable", 1)
		creqit.db.set_single_value("Google Settings", "google_drive_picker_enabled", 0)
	...
	def test_google_disabled(self):
		...
		creqit.db.set_single_value("Google Settings", "enable", 0)
		creqit.db.set_single_value("Google Settings", "google_drive_picker_enabled", 1)
		settings = get_file_picker_settings()
