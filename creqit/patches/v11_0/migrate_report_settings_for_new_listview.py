...
def execute():
	...
	reports = creqit.get_all("Report", {"report_type": "Report Builder"})

	for report_name in reports:
		settings = creqit.db.get_value("Report", report_name, "json")
		if not settings:
			continue

		settings = creqit._dict(json.loads(settings))
		...
		creqit.db.set_value("Report", report_name, "json", json.dumps(settings))
