import creqit
from creqit.core.doctype.log_settings.log_settings import clear_log_table
from creqit.utils import add_to_date, today
...
def execute():
	...
	ref: https://github.com/creqit/creqit/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(creqit.db.exists(doctype, {"modified": ("<", threshold)}))


def get_current_setting(fieldname):
	try:
		return creqit.db.get_single_value("Log Settings", fieldname)
	except Exception:
