...
from creqit.utils import get_bench_path, get_site_path
from creqit.utils.file_lock import LockTimeoutError
...
def filelock(lock_name: str, *, timeout=30, is_global=False):
	...
	try:
		...
		creqit.log_error(f"Filelock: Failed to aquire {lock_path}")
