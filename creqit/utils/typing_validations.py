...
from creqit.exceptions import creqitTypeError
...
creqitPydanticConfig = ConfigDict(arbitrary_types_allowed=True)
...
def TypeAdapter(type_):
	...
	return PyTypeAdapter(type_, config=creqitPydanticConfig)
