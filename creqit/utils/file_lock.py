...
Use `creqit.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import creqit
from creqit.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in creqit.local.locked_documents:
		doc.unlock()
