...
to provide custom formatting and logging for test results in the creqit framework.
...
test results during test execution in the creqit framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from creqit.deprecation_dumpster import creqitDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=creqitDeprecationWarning)
