"""
This module handles the setup and teardown of the test environment for creqit applications.
...
def _initialize_test_environment(site, config):
	...
	creqit.flags.print_messages = logger.getEffectiveLevel() < logging.INFO
	creqit.flags.tests_verbose = logger.getEffectiveLevel() < logging.INFO
...
def _disable_scheduler_if_needed():
	...
	global scheduler_disabled_by_user
	scheduler_disabled_by_user = creqit.utils.scheduler.is_scheduler_disabled(verbose=False)
	if not scheduler_disabled_by_user:
