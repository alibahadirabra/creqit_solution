"""
This module provides functionality for discovering and organizing tests in the creqit framework.
...
logger = logging.getLogger("creqit.testing.discovery")
...
def discover_doctype_tests(doctypes: list[str], runner, app: str, force: bool = False) -> "TestRunner":
	...
	for doctype in doctypes:
		try:
			...
			doctype_app = creqit.db.get_value("Module Def", module, "app_name")
			if app is None:
				_app = doctype_app
			...
			test_module = creqit.modules.utils.get_module_name(doctype, module, "test_")
			force and creqit.db.delete(doctype)
