...
import creqit
from creqit.modules.patch_handler import get_all_patches, parse_as_configfile
from creqit.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = creqit._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
		...
		cls.bench_path = creqit.utils.get_bench_path()
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(creqit.get_app_path("creqit", "patches.txt")))
		...
		expected_patch = "creqit.core.doctype.user.patches.delete_all_users"
