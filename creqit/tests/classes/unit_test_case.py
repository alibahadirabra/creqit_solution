...
class UnitTestCase(unittest.TestCase, BaseTestCase):
	"""Unit test class for creqit tests.

	This class extends unittest.TestCase and provides additional utilities
	specific to creqit framework. It's designed for testing individual
	...
	def setUpClass(cls) -> None:
		...
		cls.module = creqit.get_module(cls.__module__)
	...
	# --- creqit Framework specific assertions
...
def _get_doctype_from_module(cls):
	...
	path = creqit.get_pymodule_path(cls.__module__)
	try:
