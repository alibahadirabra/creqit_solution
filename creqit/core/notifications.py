...
def get_notification_config():
	return {
		"for_doctype": {
			...
			"ToDo": "creqit.core.notifications.get_things_todo",
			"Event": "creqit.core.notifications.get_todays_events",
...
def get_things_todo(as_list=False):
	...
	data = creqit.get_list(
		...
		or_filters=[
			["ToDo", "allocated_to", "=", creqit.session.user],
			["ToDo", "assigned_by", "=", creqit.session.user],
		],
		as_list=True,
	)
