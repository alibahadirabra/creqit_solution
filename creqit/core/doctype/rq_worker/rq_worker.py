...
from creqit.utils import cint, convert_utc_to_system_timezone
from creqit.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> creqit._dict:
	...
	if current_job and not current_job.startswith(creqit.local.site):
		current_job = None
