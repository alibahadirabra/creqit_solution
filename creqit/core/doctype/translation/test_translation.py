...
class TestTranslation(IntegrationTestCase):
	def setUp(self):
		creqit.db.delete("Translation")

	def tearDown(self):
		creqit.local.lang = "en"
		from creqit.translate import clear_cache
...
def create_translation(key, val):
	translation = creqit.new_doc("Translation")
