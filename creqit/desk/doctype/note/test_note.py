# Copyright (c) 2015, creqit Technologies Pvt. Ltd. and Contributors and Contributors
...
class TestNote(IntegrationTestCase):
	def insert_note(self):
		creqit.db.delete("Version")
		creqit.db.delete("Note")
		creqit.db.delete("Note Seen By")

		return creqit.get_doc(doctype="Note", title="test note", content="test note content").insert()
	...
	def test_version(self):
		...
		version = creqit.get_doc("Version", dict(docname=note.name))
