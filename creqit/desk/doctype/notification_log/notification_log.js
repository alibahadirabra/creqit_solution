...
creqit.ui.form.on("Notification Log", {
	...
	set_attachment: function (frm) {
		...
		$wrapper.find(".attached-file-link").click(() => {
			const w = window.open(
				creqit.urllib.get_full_url(`/api/method/creqit.utils.print_format.download_pdf?
