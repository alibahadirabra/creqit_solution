...
class TestWorkspace(IntegrationTestCase):
	...
	def tearDown(self):
		creqit.db.delete("Workspace", {"module": "Test Module"})
		creqit.db.delete("DocType", {"module": "Test Module"})
		creqit.delete_doc("Module Def", "Test Module")
	...
	# 	if creqit.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = creqit.get_doc({"doctype": "Module Def", "module_name": module_name, "app_name": "creqit"})
...
def create_workspace(**args):
	workspace = creqit.new_doc("Workspace")
