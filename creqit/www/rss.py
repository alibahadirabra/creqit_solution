...
import creqit
from creqit.utils import cstr, escape_html, get_request_site_address, now
...
def get_context(context):
	...
	blog_settings = creqit.get_doc("Blog Settings", "Blog Settings")
