creqit.ui.TagEditor = class TagEditor {
	constructor(opts) {
		/* docs:
		Arguments
	...
	setup_tags() {
		...
		this.tags = new creqit.ui.Tags({
			...
			onTagRemove: (tag) => {
				if (!me.refreshing) {
					return creqit.call({
						method: "creqit.desk.doctype.tag.tag.remove_tag",
						args: me.get_args(tag),
						callback: function (r) {
	...
	setup_awesomplete() {
		...
		$input.on("input", function (e) {
			...
			creqit.call({
				method: "creqit.desk.doctype.tag.tag.get_tags",
				args: {
