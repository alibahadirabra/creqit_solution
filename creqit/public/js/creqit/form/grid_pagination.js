export default class GridPagination {
	...
	get_pagination_html() {
		...
		return $(`<button class="btn btn-secondary btn-xs first-page"">
				${creqit.utils.icon("sidebar-collapse", "xs")}
			</button>
			<button class="btn btn-secondary btn-xs prev-page">${creqit.utils.icon("left", "xs")}</button>
			${page_text_html}
			<button class="btn btn-secondary btn-xs next-page">${creqit.utils.icon("right", "xs")}</button>
			<button class="btn btn-secondary btn-xs last-page">
				${creqit.utils.icon("sidebar-expand", "xs")}
			</button>`);
