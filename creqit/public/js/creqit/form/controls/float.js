creqit.ui.form.ControlFloat = class ControlFloat extends creqit.ui.form.ControlInt {
	parse(value) {
	...
	get_number_format() {
		var currency = creqit.meta.get_field_currency(this.df, this.get_doc());
		return get_number_format(currency);
	}

	get_precision() {
		// round based on field precision or float precision, else don't round
		return this.df.precision || cint(creqit.boot.sysdefaults.float_precision, null);
	}
};

creqit.ui.form.ControlPercent = creqit.ui.form.ControlFloat;
