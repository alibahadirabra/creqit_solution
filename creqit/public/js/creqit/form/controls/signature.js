creqit.ui.form.ControlSignature = class ControlSignature extends creqit.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		creqit.require("/assets/creqit/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${creqit.utils.icon("restriction", "md")}</i>
