...
creqit.ui.form.ControlComment = class ControlComment extends creqit.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${creqit.avatar(creqit.session.user, "avatar-medium")}
					<div class="creqit-control col"></div>
				</div>
		...
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".creqit-control")
