...
export default class Widget {
	...
	customize(options) {
		...
		options.allow_sorting &&
			creqit.utils.add_custom_button(
				creqit.utils.icon("es-line-drag", "xs"),
				null,
				"drag-handle",
				__("Drag"),
				null,
		...
		options.allow_edit &&
			creqit.utils.add_custom_button(
				creqit.utils.icon("es-line-edit-alt", "xs"),
				() => this.edit(),
				"edit-button",
				__("Edit"),
				null,
	...
	set_title(max_chars) {
		...
		let title = max_chars ? creqit.ellipsis(base, max_chars) : base;
