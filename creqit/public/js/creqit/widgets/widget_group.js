...
creqit.provide("creqit.widget");

creqit.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
creqit.widget.make_widget = (opts) => {
	const widget_class = creqit.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = creqit.widget.make_widget({
			...widget,
...
creqit.widget.WidgetGroup = WidgetGroup;
creqit.widget.SingleWidgetGroup = SingleWidgetGroup;
