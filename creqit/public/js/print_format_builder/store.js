...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			creqit.model.clear_doc("Print Format", print_format_name);
			creqit.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = creqit.get_doc("Print Format", print_format_name);
				creqit.model.with_doctype(_print_format.doc_type, () => {
					meta.value = creqit.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return creqit.db.get_doc("Letter Head", _letterhead).then((doc) => {
