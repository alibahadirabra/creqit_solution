...
class WorkflowBuilder {
	constructor({ wrapper, page, workflow }) {
		...
		//this.page.set_indicator("Beta", "orange");//workflow sayfasından kaldırılmıştır <<creqit.v1.sevval
	...
	setup_page_actions() {
		...
		this.go_to_doctype_btn = this.page.add_menu_item(__("Go to Workflow"), () =>
			creqit.set_route("Form", "Workflow", this.workflow)
		);
	}
...
creqit.ui.WorkflowBuilder = WorkflowBuilder;
