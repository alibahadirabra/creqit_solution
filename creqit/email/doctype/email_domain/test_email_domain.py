...
class TestDomain(IntegrationTestCase):
	...
	def tearDown(self):
		creqit.delete_doc("Email Account", "Test")
		creqit.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = creqit.get_doc("Email Domain", "test.com")
		mail_account = creqit.get_doc("Email Account", "Test")
