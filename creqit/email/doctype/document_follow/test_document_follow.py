...
import creqit
import creqit.desk.form.document_follow as document_follow
from creqit.desk.form.assign_to import add
from creqit.desk.form.document_follow import get_document_followed_by_user
from creqit.desk.form.utils import add_comment
from creqit.desk.like import toggle_like
from creqit.query_builder import DocType
from creqit.query_builder.functions import Cast_
from creqit.share import add as share
...
class TestDocumentFollow(IntegrationTestCase):
	...
	def tearDown(self):
		...
		creqit.db.delete("Document Follow")
	...
	doc = creqit.get_doc(
		{
			...
			"doc.starts_on": creqit.utils.now(),
			"doc.ends_on": creqit.utils.add_days(creqit.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if creqit.db.exists("User", "test@docsub.com"):
		doc = creqit.delete_doc("User", "test@docsub.com")
	doc = creqit.new_doc("User")
