...
from creqit.utils import add_to_date, get_link_to_form, today
from creqit.utils.data import is_html
...
class TestAutoEmailReport(IntegrationTestCase):
	def test_auto_email(self):
		creqit.delete_doc("Auto Email Report", "Permitted Documents For User")
...
def get_auto_email_report():
	if not creqit.db.exists("Auto Email Report", "Permitted Documents For User"):
		auto_email_report = creqit.get_doc(
		...
		auto_email_report = creqit.get_doc("Auto Email Report", "Permitted Documents For User")
