...
import creqit
from creqit import safe_decode
from creqit.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from creqit.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from creqit.email.receive import Email
...
<div>
	...
	<img embed="assets/creqit/images/creqit-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/creqit/images/creqit-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = creqit.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="creqit-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/creqit/images/creqit-favicon.svg" alt="test" />
...
From: test1_@creqit.com
Reply-To: test2_@creqit.com
"""
			+ text_content_bytes
		)
