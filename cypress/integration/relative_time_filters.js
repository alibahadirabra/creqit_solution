...
// 		cy.window().its('creqit').then(creqit => {
// 			creqit.call("creqit.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/creqit.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/creqit.model.utils.user_settings.save')
