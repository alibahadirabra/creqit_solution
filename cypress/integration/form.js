...
context("Form", () => {
	before(() => {
		...
		return cy
			...
			.its("creqit")
			.then((creqit) => {
				return creqit.call("creqit.tests.ui_test_helpers.create_contact_records");
			});
	});
	...
	it("create a new form", () => {
		...
		cy.intercept({
			method: "POST",
			url: "api/method/creqit.desk.form.save.savedocs",
		}).as("form_save");
	...
	it("validates behaviour of Data options validations in child table", () => {
		...
		cy.get('.creqit-control[data-fieldname="email_ids"]').as("table");
